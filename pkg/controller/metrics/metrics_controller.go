...
import (
	...
	openshiftv1alpha1 "github.com/fedepaol/network-metrics/pkg/apis/openshift/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &openshiftv1alpha1.Metrics{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &openshiftv1alpha1.Metrics{},
	})
	if err != nil {
		return err
	}
...
// blank assignment to verify that ReconcileMetrics implements reconcile.Reconciler
...
func (r *ReconcileMetrics) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &openshiftv1alpha1.Metrics{}
	...
	// Set Metrics instance as the owner and controller
...
func newPodForCR(cr *openshiftv1alpha1.Metrics) *corev1.Pod {
